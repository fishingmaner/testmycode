...
<div class="ui container">
    <div class="ui three column grid" style="margin-top:10px;">
        ...
        <div class="fourteen wide center aligned green column button" data-id={{ order.id }}><h5>支付</h5></div>
        <div class="one wide column"></div>
    </div>
    <div class="ui three column grid" style="margin-top:10px;">
        <div class="one wide column"></div>
        <div class="fourteen wide center aligned grey column" data-id={{ order.id }}><h5>撤销</h5></div>
        <div class="one wide column"></div>
    </div>
</div>
<script>
